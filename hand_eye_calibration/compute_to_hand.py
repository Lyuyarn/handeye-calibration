...
images_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),"2025-08-21_2")
...
def func():
    ...
    for i in range(0, len(images_num)):   #标定好的图片在images_path路径下，从0.jpg到x.jpg
        ...
        if os.path.exists(image_file):
            ...
            #error_num = [11,17,18,24,25,26,0,2,5,8]
    ...
    poses2_main(images_path,error_num)
    # 机器人末端在基座标系下的位姿
